<?php
	...
	$name = $_POST['name']; $email = $_POST['email']; $numberofguests = $_POST['numberofguests']; $attendto = $_POST['attendto']; $comments = $_POST['comments'];
...
if(mail($address, $e_subject, $msg, $headers)) { echo "<fieldset><div id='success_page'><p>Thank you $name, your reservation request has been submitted to us.</p></div></fieldset>"; }